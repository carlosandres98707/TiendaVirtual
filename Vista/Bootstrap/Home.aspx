<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="ProyectoCiberVentas.Vista.Bootstrap.Home" %>
...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="carrito.aspx">Mis pedidos</a>
       <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="ConfigurarUsuario.aspx">Configuracion</a>
       <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="Inicio.aspx">Cerrar sesion</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <h1 class="masthead-heading text-uppercase mb-0">¡Bienvenido/a!</h1>
                <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="carrito.aspx"><img src="../../Imagenes/comercio.png" /></a>
                <h3>Mi carrito</h3>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                   ...
                                   <table cellspacing: 10px;>
                                    ...
                                    <a href="computador.aspx"><button type="button" class="btn btn-primary" >Comprar Producto</button></a>
                                ...
                                <div class="col-lg-8">
                                   ...
                                   <p align="justify">
                                     ...
                                     -  Pantalla de 6,3" para ver tus películas favoritas.
                                       ...
                                       <a href="celular.aspx"><button type="button" class="btn btn-primary" >Comprar Producto</button></a>
                    ...
                    <div class="modal-body text-center">
                        <div class="container">
                            <div class="row justify-content-center">
                                ...
                                <a href="tablet.aspx"><button type="button" class="btn btn-primary" >Comprar Producto</button></a>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                   ...
                                   <p align="justify">
                                     ...
                                     <a href="equipo.aspx"><button type="button" class="btn btn-primary" >Comprar Producto</button></a>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <p align="justify">
                                     ...
                                     <a href="lavadora.aspx"><button type="button" class="btn btn-primary" >Comprar Producto</button></a>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                   ...
                                   <p align="justify">
                                     ...
                                     <a href="nevera.aspx"><button type="button" class="btn btn-primary" >Comprar Producto</button></a>
